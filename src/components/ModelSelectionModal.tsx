...
interface ModelSelectionModalProps {
  ...
  repositoryType?: 'github' | 'gitlab' | 'bitbucket' | 'gitcode';
  // Authentication
...
export default function ModelSelectionModal({
  ...
  const [localSelectedPlatform, setLocalSelectedPlatform] = useState<'github' | 'gitlab' | 'bitbucket' | 'gitcode'>(repositoryType);
